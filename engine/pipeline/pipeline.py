...
from engine.vision.ai_engine import ai_engine
from engine.vision.zone_monitor import ZoneMonitor
from engine.vision.zone_store import zone_store
from engine.health.health_monitor import system_health, CameraHealthMonitor
from engine.situations.situation_engine import situation_engine
from engine.storage.storage_queue import storage_queue
from engine.vision.tamper_detector import tamper_detector
...
from engine.pipeline.frame_buffer import CircularFrameBuffer
        ...
        while self.running:
            ...
            if is_monitoring and current_zones:
                try:
                    ...
                    # Extract 10s of rolling pre-event camera frames (T-10s -> T-0)
                    pre_roll_frames = self.frame_buffer.get_last_seconds(10.0)
                    ...
                    # 5. Central Tamper Incident Lifecycle Evaluation (with 10s pre-tamper buffer)
